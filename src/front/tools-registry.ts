...
export const TOOLS: Tool[] = [
  ...
  { id: "generar-imagen", name: "Generar imágenes", desc: "Imágenes a partir de texto (FLUX/SDXL)", categories: ["imagen", "creacion"], icon: Wand2, availability: "no-disponible", note: "Todavía no existe: no hay modelos de imagen instalados ni acción de generación (lo confirma AVATAR AI, 24/09).", owner: "AVATAR AI" },
  ...
  { id: "doblaje", name: "Doblar vídeos", desc: "Estudio de doblaje de vídeos propios", categories: ["video", "audio"], icon: AudioLines, availability: "pendiente", note: "Especificado (claude/willy-video-dubbing-studio-spec.md), en cola, sin código todavía. Mientras tanto: «Traducir un vídeo de YouTube».", owner: "AVATAR AI" },
  // ── Audio y voz
  ...
  { id: "influencer", name: "IA Influencer", desc: "Identidades virtuales con imágenes coherentes, voz y vídeos", categories: ["creacion"], icon: UserRound, availability: "no-disponible", note: "Todavía no existe código de identidades ni de imagen (AVATAR AI, 24/09). Pendiente de que el dueño decida su prioridad.", owner: "AVATAR AI" },
